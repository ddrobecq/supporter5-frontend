...
import { createNatio, deleteNatio, fetchNatio, fetchNatioById, updateNatio } from './natioApi';
  ...
  return (
    <Stack spacing={2}>
      ...
      <Dialog open={confirmDeleteOpen} onClose={() => setConfirmDeleteOpen(false)}>
        ...
        <DialogActions>
          <Button onClick={() => setConfirmDeleteOpen(false)} color="inherit">Annuler</Button>
