    ...
    themes: [
      {
        ...
        label: 'Résumé',
        types: [
          { key: 'temps', label: 'Temps de jeu' },
          { key: 'buts', label: 'Buteurs' },
          { key: 'passes', label: 'Passeurs' },
          { key: 'sanctions', label: 'Sanctions' },
          { key: 'equipe-type', label: 'Equipe type' },
        ],
      },
      {
        key: 'composition',
        label: 'Composition',
        types: [
          { key: 'nombre-joueurs', label: 'Nombre de joueurs' },
          { key: 'nombre-etrangers', label: "Nombre d'étranger" },
          { key: 'nombre-nationalites', label: 'Nombre de nationalités' },
          { key: 'age-moyen', label: "Moyenne d'âge" },
          { key: 'nombre-matches', label: 'Nombre de matches' },
          { key: 'nombre-remplacements', label: 'Remplacements par match' },
          { key: 'evolution-schema', label: 'Évolution du schéma' },
        ],
      },
      {
        key: 'buts-equipe',
        label: 'Performance',
        types: [
          { key: 'buts-pour', label: 'Buts Pour' },
          { key: 'buts-contre', label: 'Buts Contre' },
          { key: 'buts-pour-match', label: 'Buts Pour par Match' },
          { key: 'buts-contre-match', label: 'Buts Contre par Match' },
          { key: 'buts-match', label: 'Nombre de Buts par match' },
        ],
      },
      {
        key: 'sanctions-equipe',
        label: 'Sanction',
        types: [
          { key: 'avertissements', label: 'Avertissements' },
          { key: 'exclusions', label: 'Expulsions' },
          { key: 'avertissements-match', label: 'Avertissements par Match' },
          { key: 'exclusions-match', label: 'Expulsions par Match' },
        ],
      },
      {
        key: 'transferts-equipe',
        label: 'Transfert',
        types: [
          { key: 'achats-cumules', label: 'Achats cumulés' },
          { key: 'ventes-cumulees', label: 'Ventes cumulées' },
        ],
      },
    ],
  },
    ...
    themes: [
      ...
      },
      {
        ...
        types: [
          ...
          { key: 'doubles', label: 'Nombre de doublés' },
          { key: 'triples', label: 'Nombre de triplés' },
          { key: 'quadruples', label: 'Nombre de quadruplés' },
