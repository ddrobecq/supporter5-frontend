...
export function ArbitreIdentityDisplay({ arbitreId, size = 30, compact = false }: ArbitreIdentityDisplayProps) {
  ...
  if (!normalizedId) {
    return (
      <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center', minWidth: 0 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ fontSize: compact ? 11 : 12 }}>
          Aucun arbitre
        </Typography>
      </Stack>
    );
